...
namespace Marmary.SettingsSystem.UnityComponents
{
    ...
    public class SetResolutionCombobox : MonoBehaviour
    {
        ...
        /// <summary>
        ///     Reference to the injected resolution options provider.
        /// </summary>
        private ISettingsOptions<Vector2Int> _resolutionOptions;
        ...
        /// <summary>
        ///     Injects the keyed resolution settings dependency and its options provider.
        /// </summary>
        /// <param name="resolutionSettings">The keyed settings instance for resolution configuration.</param>
        /// <param name="resolutionOptions">The keyed options provider for available resolutions.</param>
        [Inject]
        public void Construct(
            [Key(CommonSettings.Resolution)] SettingsConfigureBase<Vector2Int> resolutionSettings,
            [Key(CommonSettings.Resolution)] ISettingsOptions<Vector2Int> resolutionOptions)
        {
        ...
        private void Start()
        {
            ...
            var resolutionOptions = _resolutionOptions.GetOptionsToString();
